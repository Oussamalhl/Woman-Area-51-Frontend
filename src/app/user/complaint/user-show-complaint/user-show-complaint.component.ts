...
@Component({
  selector: 'app-user-show-complaint',
  templateUrl: './user-show-complaint.component.html',
  styleUrls: ['./user-show-complaint.component.scss']
})
export class UserShowComplaintComponent implements OnInit {

  listComplaints:Complaint[]=[];
  dataSource = new MatTableDataSource<Complaint>(this.listComplaints);

  columnsToDisplay = ['description', 'complainttype','Remove'];
  comp!:Complaint;
